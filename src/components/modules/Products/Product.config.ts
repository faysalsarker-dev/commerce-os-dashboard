import { useGetCategoriesForSelectQuery} from "@/redux/hooks";
...
export const productFormConfig = createForm<ProductFormValues>()
  ...
  .field("categoryId", { kind: "relation", label: "Category", useQueryHook: useGetCategoriesForSelectQuery, labelKey: "name", valueKey: "id" })
